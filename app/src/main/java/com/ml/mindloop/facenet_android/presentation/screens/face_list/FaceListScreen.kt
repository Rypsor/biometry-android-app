    ...
    FaceNetAndroidTheme {
        Scaffold(
            ...
            Column(modifier = Modifier.padding(innerPadding)) {
                ScreenUI(viewModel, onEditFaceClick)
                AppAlertDialog()
            }
        }
    }
...
@Composable
private fun ScreenUI(viewModel: FaceListScreenViewModel, onEditFaceClick: (Long) -> Unit) {
    val faces by viewModel.personFlow.collectAsState(emptyList())
    LazyColumn { items(faces) { FaceListItem(it, onEditFaceClick = onEditFaceClick) { viewModel.removeFace(it.personID) } } }
}
...
private fun FaceListItem(
    ...
    Row(
        ...
        Icon(
            modifier = Modifier.clickable { onEditFaceClick(personRecord.personID) },
            imageVector = Icons.Default.Edit,
            contentDescription = "Edit face",
        )
